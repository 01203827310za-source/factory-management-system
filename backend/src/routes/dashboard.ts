...
router.get('/', async (req: Request, res: Response) => {
  try {
    ...
    const receivableItems: Array<{ source: 'sale' | 'sale_shipping_gap' | 'client_account'; name: string; reference: string; invoice_total: number; paid: number; remaining: number }> = [];
    sales
